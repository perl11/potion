/* A recursive-descent parser generated by greg 0.3.0, not yet generated by greg 0.4.4 */
/* G->debug or -v verbose still not ported over from compile.c */
...
#endif
#ifdef YY_DEBUG
# define yyprintf(args)	if (G->debug) fprintf args
#else
...
{
   yyprintf((stderr, "do yy9_primary @ \"%s\"\n", yytext));
