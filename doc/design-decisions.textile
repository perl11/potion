...
beautiful. It's art not technology.
short, precise, readable. no one wants to work with a big and ugly mess,
not even companies. rather restrict the usage to those who know and
can be taught, than sacrifice your system for it.  support 90% but do
not sacrifice for the rest.  gmake and gcc/clang are available
everywhere, even on pure bsd's.
