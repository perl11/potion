...
have the same syntax as @leg@, and may use the same nonterminal
symbols from the grammer, i.e. the left hand side of the grammar rules,
but the body is written in native perl5,
with a mix of compile-time and run-time expressions.
