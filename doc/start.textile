...
There is also an addendum to that: _Oh, and everything is a function._
...
I know this isn't terribly useful, but it's an infinite printing of the word "QUAFF."
...
Functions are all over Potion. Whether its anonymous lambdas, blocks or type functions.
...
Lastly, here we have a *lick*. This is the data language brought up earlier in the section about special things. It won't really be covered in this little pamphlet, but it's something to mention.
